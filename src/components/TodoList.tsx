...
class TodoList extends React.Component<IProps, IState> {
  ...
  onToggle = (id: number): void => {
    ...
    const index: number = todoItems.findIndex(todo => todo.id === id); // id 로 인덱스 찾기
    const selectedItem: ITodoItemData = todoItems[index]; //  아이템 선택
    const nextItems: ITodoItemData[] = [...todoItems]; // 배열 내용을 복사
